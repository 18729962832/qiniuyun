...
public class StringUtil {
    ...
    public static String[] sortArraystoBigDecimal(String[] arrays) {
        ...
        for (int i = 0; i < arrays.length - 1; i++) {
            ...
            for (int j = 0; j < arrays.length - i - 1; j++) {
                ...
                if (StringUtil.getStrToBigDecimal(arrays[j])
                        .compareTo(StringUtil.getStrToBigDecimal(arrays[j + 1])) == 1) {
                    temp = arrays[j + 1];
                    arrays[j + 1] = arrays[j];
                    arrays[j] = temp;
                }
    ...
    public static String formatDate(String format, Date dt) {
        ...
        if (!StringUtil.isValidStr(format)) {
            format = "yyyy-MM-dd";
        }
     ...
     * @return
     */
    public static JSONArray getStrToJSONArray(String str) {
